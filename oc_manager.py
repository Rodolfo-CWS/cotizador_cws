        ...
        for intento in range(max_intentos):
            try:
                ...
                if not self.pg_connection or self.pg_connection.closed:
                    ...
                    print(f"[OC_MANAGER] Intentando conectar a PostgreSQL (intento {intento + 1}/{max_intentos})...")
                    self.pg_connection = psycopg2.connect(self.database_url)
                    print(f"[OC_MANAGER] Conexión PostgreSQL establecida exitosamente")
                ...
                print(f"[OC_MANAGER] Error en intento {intento + 1}: {e}")
                ...
                if intento == max_intentos - 1:
                    print(f"[OC_MANAGER] ❌ Base de datos no disponible después de {max_intentos} intentos")
